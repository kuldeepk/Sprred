...
$professionalInfo = new ProfessionalInfoDAO($userID);
$view = new ViewPosts($userID, Auth::getLoggedInID());
$posts = $view->getAllPosts(10 , 0);

$current_page = "info";

require(dirname(__FILE__).'/../../templates/themes/'.$theme.'/info.php');
